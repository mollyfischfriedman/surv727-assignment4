...
*There were the most arrests due to theft in 2016 in Chicago.*
...
``` {r}
query <-"SELECT primary_type, count(*) FROM crime WHERE year = 2016 AND district = 11 GROUP BY primary_type ORDER BY count(*) DESC LIMIT 10;"
```
